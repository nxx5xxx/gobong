...
insert into user1 values('test1','테스트','1234','ddd@test.com','010-0000-0000',default);
commit;
select * from user1;

create table test1(aa varchar2(50),bb varchar2(50));
insert into test1 values('테스트123','테스트456');
